  ...
  render() {
    ...
    return (
      <article>
        <Helmet>
          <title>Home</title>
          <meta name="description" content="Repos listing and README scraper" />
        </Helmet>
        <div className="home-page">
          <section className="centered">
            <h2>Fetch Github Repos and their respective README files!</h2>
            <p>A <i>LeadIQ</i> test designed to impress their developers</p>
          </section>
          {renderBodyComponent}
        </div>
      </article>
